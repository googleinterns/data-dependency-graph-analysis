...
class ConnectionGenerator:
    ...
    Attributes:
        ...
        dataset_count_map: Dictionary that maps number of datasets in collection to count of dataset collections.
        system_count: Integer of how many systems are in a graph.
        system_count_map: Dictionary that maps number of systems in collection to count of system collections.
        ...
        dataset_read_count_map: Dictionary that maps number of system inputs of dataset read to count of dataset reads.
        system_input_count_map: Dictionary that maps number of dataset reads by system input to count of system inputs.
        dataset_write_count_map: Dictionary that maps number of system outputs of dataset write to count of dataset writes.
        system_output_count_map: Dictionary that maps number of dataset writes by system output to count of system outputs.
        datasets_conn_collection: Dictionary that maps dataset collection id to dataset ids.
        systems_conn_collection: Dictionary that maps system collection id to system ids.
        dataset_read_conn_systems: Dictionary that maps dataset read id to system ids this dataset inputs to.
        dataset_write_conn_systems: Dictionary that maps dataset write id to system ids this dataset is output from.
    ...
    def get_one_to_many_connections(element_count, element_count_map):
        ...
        Args:
            ...
            element_count_map: Dictionary that maps element count in a group to number of groups with that count.

        Returns:
            Dictionary that maps group id to a list of element ids.
        """
        # Create element ids
    ...
    def get_many_to_many_connections(element_1_count, element_2_count, element_1_count_map, element_2_count_map):
        ...
        Args:
            ...
            element_1_count_map: Dictionary that maps element 1 count in element 2 group to number of elements 2.
            element_2_count_map: Dictionary that maps element 2 count in element 1 group to number of elements 1.
